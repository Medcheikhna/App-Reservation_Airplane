                ...
                <div class="col-md-6">
                    <div class="form-block">
                        <div class="text-center mb-5">
                            <h3>Sign up <strong>To Travel</strong></h3>
                            <% if (request.getParameter("erreur") != null && request.getParameter("erreur").equals("exist")) { %>
                            <p style="color: red;">Cet utilisateur existe déjà. Veuillez choisir un autre nom d'utilisateur.</p>
                            <% } %>
                        ...
                        <form action="SignUpServlet" method="post">
                            ...
                            <div class="form-group last mb-3">
                                ...
                                <input type="password" class="form-control" placeholder="confirm your Password" id="confirmerMotDePasse" name="confirmerMotDePasse" required>
                            </div>
